...
- Start with this README to understand the scope.
- Read [docs/architecture.md](docs/architecture.md) for the full architecture note.
...
Useful contributions include clearer wording, better diagrams, safer bridge design notes, platform mapping examples, threat-model improvements, and proof-of-concept sketches.

Please avoid changes that turn this into a public API proxy guide, encourage account sharing, bypass usage limits, or expose a local bridge to untrusted users.
